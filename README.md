...
## Student Information
- **Name:** Rutayisire Gihozo Rolando
- **Student ID:** 29152
...
**PDB Created:** `[RO_pdb_29152]`  
**Username:** `[ROLANDO_PLSQLAUCA_29152]`

**Commands:**
```sql
CREATE PLUGGABLE DATABASE [pdb_name]
ADMIN USER [ROLANDO_PLSQLAUCA_29152] IDENTIFIED BY [12345]
FILE_NAME_CONVERT = ('pdbseed', '[pdb_RO_pdb_29152]');

ALTER PLUGGABLE DATABASE [pdb_RO_pdb_29152] OPEN;
GRANT CONNECT, RESOURCE, DBA TO [ROLANDO_PLSQLAUCA_29152];
```
...
ADMIN USER RO_pdb_29152 IDENTIFIED BY [12345]
